...
unsigned int Morton::encode(const unsigned int *cartesian_coordinates, unsigned int dim){
  unsigned int code = 0;
...
void Morton::decode(unsigned int *cartesian_coordinates, unsigned int dim, unsigned code){
  for (unsigned int i = 0; i < dim; ++i)
